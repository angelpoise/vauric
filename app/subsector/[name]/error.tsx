...
export default function SubsectorError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div style={{ minHeight: "100vh", background: "#07090f", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: '"DM Sans", sans-serif' }}>
      <div style={{ textAlign: "center" }}>
        <div style={{ fontSize: 13, color: "#475569", marginBottom: 16 }}>
          {error.message?.includes("not found") ? "Sub-sector not found." : "Something went wrong loading this sub-sector."}
        </div>
